<div class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-12 mt-6 sm:mt-10 px-4">
    <div class="w-full relative">
        <img class="w-full h-64 sm:h-96 object-cover rounded-lg" src="/img/image.png" alt="Pannenkoeken">
        <h2 class="absolute bottom-4 left-4 text-text bg-primary p-2 rounded-md opacity-90 text-lg">Pannenkoeken</h2>
